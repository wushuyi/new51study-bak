...
export function propTypesFromConnect (mapping, extra = null, addReducer) {
  let propTypes = Object.assign({}, mapping.propTypes || mapping.passedProps || {})

  if (mapping.props) {
    const propsArray = deconstructMapping(mapping.props, addReducer)
  ...
  if (mapping.actions) {
    const actionsArray = deconstructMapping(mapping.actions, addReducer)
